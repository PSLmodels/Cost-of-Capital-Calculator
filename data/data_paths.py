...
def get_paths():
    ...
    paths["_SOI_BEA_CROSS"] = os.path.join(_BEA_DIR, "soi_bea_industry_codes.csv")
    paths["_BEA_INV"] = os.path.join(_BEA_DIR, "NIPA_5.8.5B.xls")
    paths["_BEA_RES"] = os.path.join(_BEA_DIR, "BEA_StdFixedAsset_Table5.1.xls")
    ...
    paths["_TYP_IN_CROSS_PATH"] = os.path.join(_PRT_DIR, "13pa05_Crosswalk.csv")
