...
from ccc.constants import MAJOR_ASSET_GROUPS, MINOR_ASSET_GROUPS, BEA_CODE_DICT
...
asset_data_by_tax_treat = pd.DataFrame(
    asset_data.groupby(
        [
            "tax_treat",
            "Asset Type",
...
# save result to csv
asset_data_by_tax_treat.to_csv(os.path.join(_CUR_DIR, "ccc_asset_data.csv"))
