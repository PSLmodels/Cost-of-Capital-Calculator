...
def asset_calcs(p, asset_data):
    ...
    asset_dict = p.asset_dict
    major_asset_groups = p.major_asset_groups
...
def industry_calcs(p, asset_data, output_by_asset):
    """
