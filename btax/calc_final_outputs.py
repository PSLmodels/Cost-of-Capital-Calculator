...
def industry_calcs(params, asset_data, output_by_asset):
    ...
    by_industry_asset = by_industry_asset[by_industry_asset['Asset Type']!='Land'].copy()
    by_industry_asset = by_industry_asset[by_industry_asset['Asset Type']!='Inventories'].copy()
    ...
    output_by_asset = output_by_asset[output_by_asset['Asset Type']!='Inventories'].copy()
