...
def calibrate_financing():
	...
	corp_equity_df = pd.read_csv(_EQUITY_CORP,
                                 ...
                                 names=column_name, nrows=num_rows[1])

	amt = corp_equity_df[corp_equity_df.index==0]['Amount'][0]
    ...
    amt = corp_equity_df[corp_equity_df.index==3]['Amount']
...
def calc_after_return(indust_debt):
	...
	after_tax_return = debt_ratio * (nominal_mrkt_intrst - inflation_rate) + \
                       equity_ratio * real_rate_return
