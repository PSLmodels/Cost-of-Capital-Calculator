...
def get_paths():
    ...
    paths['_INC_FILE'] = _INC_FILE = os.path.join(_PRT_DIR, '15pa01.xls')
    paths['_AST_FILE'] = _AST_FILE = os.path.join(_PRT_DIR, '15pa03.xls')
    paths['_TYP_IN_CROSS_PATH'] = _TYP_IN_CROSS_PATH =\
        os.path.join(_PRT_DIR, '13pa05_Crosswalk.csv')
    paths['_TYP_FILE'] = _TYP_FILE = os.path.join(_PRT_DIR, '15pa05.xls')
